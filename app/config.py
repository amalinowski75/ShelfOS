...
# printer sitting on somebody's desk (see docs/label-printing.md). Empty (the
# default) means no printer: labels can still be previewed and printed through
# the browser, and the print buttons stay hidden. The raster bytes go to this
# device directly;
