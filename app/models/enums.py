...
class MatchDomain(enum.StrEnum):
    ...
    ShelfOS value. TYPE, MOUNTING and PACKAGE are global; PARAM_NAME and ENUM_VALUE
    are scoped to one parameter definition.
    """

    TYPE = "type"  # canonical = a component type name
    MOUNTING = "mounting"  # canonical = a MountingType value
    PACKAGE = "package"  # canonical = the package text stored on the component
